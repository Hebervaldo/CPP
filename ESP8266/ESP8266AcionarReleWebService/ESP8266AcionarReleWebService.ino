//****************************************************************************************
//                             ESP 8266 Acionador de Rele 
//                       Hebervaldo de Paula Carvalhedo, Julho 2017
//****************************************************************************************

// Build 1
//   r1 - Acionador de Rele, webserver, email, etc.
...
String assunto = "ESP 8266 - Acionador de Reler";
String mensagem = "";
...
void mtdExecutarModoAcionarRele()
{
  if(modoAcionarRele)
  {
...
void mtdGerarPaginaWebService()
{
  ...
  buf += "<p>Acionar o Rele. <a href=\"?function=btnModoAcionarRele_on\"><button>ON</button></a> <a href=\"?function=btnModoAcionarRele_off\"><button>OFF</button></a></p>";
  ...
  buf += "<br>";
  buf += "Modo Rele: ";
  buf += String(modoAcionarRele ? "Ativado" : "Desativado");
  buf += "<br>";
  buf += "Numero boot: ";
  buf += String(boot_num);
  buf += "<br>";
  ...
  if(req.indexOf("btnModoAcionarRele_on") != -1)
  {
    modoAcionarRele = true;
  }

  if(req.indexOf("btnModoAcionarRele_off") != -1)
  {
...
{
  assunto = "ESP 8266 - Acionador de Rele";
  ...
  mensagem += "\n\r";
  mensagem += "Modo Rele: ";
  mensagem += String(modoAcionarRele ? "Ativado" : "Desativado");
  mensagem += "\n\r";
